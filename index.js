...
console.log("--------------------------------------------------------------------");
console.log("--------------------------------------------------------------------");
console.log("Welcome to your basic calculator! Please begin by entering the two numbers you wish to work with.");
...
if (holder.operator === "Addition") {
    ...
    console.log(`${holder.operator} of ${holder.firstNumber} and ${holder.secondNumber} is: ${answer}`);
}
